---
title: Deepsec is an agent-powered scanner finding hard-to-find vulnerabilities
source: hn
...
interest_score: 8
hn_id: '48964215'
comments: https://news.ycombinator.com/item?id=48964215
why_read: This text introduces Deepsec, an agent-powered tool designed to uncover
  hard-to-find security vulnerabilities in extensive codebases. Readers will understand
  its purpose, unique capabilities, and the potential cost-benefit considerations
  for its use in security audits.
authors:
- handfuloflight
image: 12-hn-48964215-infographic.png
---

![](12-hn-48964215-infographic.png)
